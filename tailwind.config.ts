...
const config: Config = {
  ...
  darkMode: ["class"],
  safelist: [
    "autofill:bg-transparent", // to avoid purging autofill styles
  ],
  theme: {
    extend: {
      fontFamily: {
      ...
      fontSize: {
        "heading-0": ["72px", "86px"], // Massive display text
        "heading-1": ["60px", "72px"],
        "heading-2": ["48px", "58px"],
        "heading-3": ["40px", "48px"],
        "heading-4": ["35px", "45px"],
        "heading-5": ["28px", "40px"],
        "heading-6": ["24px", "30px"],
        "heading-7": ["20px", "28px"], // Smaller heading
        "body-2xlg": ["22px", "28px"],
        "body-lg": ["18px", "26px"], // Larger body text
        "body-md": ["16px", "24px"], // Standard body text
        "body-sm": ["14px", "22px"],
        "body-xsm": ["13px", "20px"], // Smaller body text
        "body-2xs": ["11px", "18px"], // Extra small body text
        caption: ["10px", "16px"], // Caption or footnote
        "caption-sm": ["9px", "14px"], // Smallest caption
      },
      fontWeight: {
        thin: "100",
        extralight: "200",
